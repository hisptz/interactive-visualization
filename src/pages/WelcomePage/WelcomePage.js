...
const steps = [
    {
        ...
        intro: "Click here to start configuring your app"
    }
]
    ...
    return (
        <div style={{
            ...
            <div style={{gap:20, position:"relative", display:"flex", justifyContent:"center", paddingTop:30}}>
                <Button id="get-started"  onClick={() => setOpenHelper(true) }>Helper</Button>
                <Button  onClick={() => navigate("/visualization")}>Get started</Button>
            </div>
